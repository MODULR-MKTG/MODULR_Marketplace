...
| `modulr-skills`                        | A growing collection of standalone skills we use in production: `anti-ai-phrases` (scrub AI tells), `price-check` (objective pricing audit), `email-engagement-analysis` (email program deep-dive → branded PDF), `musk-algorithm` (first-principles efficiency audit). |
